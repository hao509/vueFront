          ...
          <div class="ritCont">
            ...
            <div class="items">
              ...
              >
                ...
                >
                  <img
                    src="../../styles/images/icons/btn_clean@2x.png"
                    alt=""
                  >
                </span>
              </div>
...
<script>
import { querySetmealById, getCategoryList, addSetmeal, editSetmeal, queryDishList } from '../../utils/api/combo'
export default {
  name: 'ComboAdd',
  data () {
    return {
